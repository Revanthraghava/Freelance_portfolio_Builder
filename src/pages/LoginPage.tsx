    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-[3rem] shadow-2xl border border-white p-12">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 font-medium">Log in to manage your portfolios.</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-slate-500 font-medium">
            Don't have an account? <Link to="/register" className="text-indigo-600 font-bold hover:underline">Join Now</Link>
          </p>
        </div>
      </div>
    </div>
